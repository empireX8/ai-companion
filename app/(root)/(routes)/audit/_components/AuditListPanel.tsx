    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 items-center justify-between border-t border-border/40 px-3 py-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-muted-foreground">Weekly Reviews</span>
        </div>
      ...
      {loading ? (
        ...
        <p className="flex-1 p-3 text-xs text-muted-foreground">Sign in to view reviews.</p>
      ) : error ? (
