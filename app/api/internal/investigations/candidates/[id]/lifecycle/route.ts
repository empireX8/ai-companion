...
} from "../../../../../../../lib/investigation-candidate-lifecycle-persistence";
...
export async function POST(
  ...
  try {
    ...
    if (error instanceof InvestigationLifecyclePersistenceError) {
      if (
    ...
    console.error("[INTERNAL_INVESTIGATION_CANDIDATE_LIFECYCLE_POST_ERROR]", error);
