/**
 * READ-ONLY account gate for CONTRADICTION-CONFIDENCE-CALIBRATION-001 (CEQR-006).
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/CONTRADICTION-CONFIDENCE-CALIBRATION-001/readonly-account-gate.mjs --label ceqr-006-before
 *   node docs/agent-runs/receipts/CONTRADICTION-CONFIDENCE-CALIBRATION-001/readonly-account-gate.mjs --label ceqr-006-after
 */
...
async function main() {
  ...
  const out = {
    ...
    slice: "CONTRADICTION-CONFIDENCE-CALIBRATION-001",
    campaignSlice: "CEQR-006",
    phase: "ceqr_006_confidence_calibration",
    label,
    userId: KAY,
    queriedAt,
    mode: "read_only",
