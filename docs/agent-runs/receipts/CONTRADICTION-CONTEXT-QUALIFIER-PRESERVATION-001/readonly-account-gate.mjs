/**
 * READ-ONLY account gate for CEQR-003 / CONTRADICTION-CONTEXT-QUALIFIER-PRESERVATION-001.
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/CONTRADICTION-CONTEXT-QUALIFIER-PRESERVATION-001/readonly-account-gate.mjs [--label before|after]
 */
...
async function main() {
  ...
  const out = {
    campaign: "CONTRADICTION-CONTEXT-QUALIFIER-PRESERVATION-001",
    slice: "CEQR-003",
