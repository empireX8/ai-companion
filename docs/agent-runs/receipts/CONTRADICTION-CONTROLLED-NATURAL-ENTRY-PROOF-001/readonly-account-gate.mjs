/**
 * READ-ONLY account gate for CONTRADICTION-CONTROLLED-NATURAL-ENTRY-PROOF-001
 * (CEQR-010).
 *
 ...
 *   node docs/agent-runs/receipts/CONTRADICTION-CONTROLLED-NATURAL-ENTRY-PROOF-001/readonly-account-gate.mjs --label controlled-natural-entry-proof-before
 *   node docs/agent-runs/receipts/CONTRADICTION-CONTROLLED-NATURAL-ENTRY-PROOF-001/readonly-account-gate.mjs --label controlled-natural-entry-proof-after
 */
...
async function main() {
  ...
  const out = {
    ...
    slice: "CONTRADICTION-CONTROLLED-NATURAL-ENTRY-PROOF-001",
    campaignSlice: "CEQR-010",
    phase: "controlled_natural_entry_proof_001",
    label,
    userId: KAY,
    queriedAt,
    mode: "read_only",
