/**
 * READ-ONLY account gate for CONTRADICTION-EXTRACTION-QUALITY-REPAIR-001 Phase A.
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/CONTRADICTION-EXTRACTION-QUALITY-REPAIR-001/readonly-phase-a-account-gate.mjs [--label before|after]
 */
