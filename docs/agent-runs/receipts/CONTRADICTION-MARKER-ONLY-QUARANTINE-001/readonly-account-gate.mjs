/**
 * READ-ONLY account gate for CEQR-002 / CONTRADICTION-MARKER-ONLY-QUARANTINE-001.
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/CONTRADICTION-MARKER-ONLY-QUARANTINE-001/readonly-account-gate.mjs [--label before|after]
 */
...
async function main() {
  ...
  const out = {
    campaign: "CONTRADICTION-MARKER-ONLY-QUARANTINE-001",
    slice: "CEQR-002",
