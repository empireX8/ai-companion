/**
 * READ-ONLY account gate for CEQR-004 / CONTRADICTION-SAME-SESSION-ZERO-OR-ONE-SELECTION-001.
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/CONTRADICTION-SAME-SESSION-ZERO-OR-ONE-SELECTION-001/readonly-account-gate.mjs [--label before|after]
 */
...
async function main() {
  ...
  const out = {
    campaign: "CONTRADICTION-SAME-SESSION-ZERO-OR-ONE-SELECTION-001",
    slice: "CEQR-004",
