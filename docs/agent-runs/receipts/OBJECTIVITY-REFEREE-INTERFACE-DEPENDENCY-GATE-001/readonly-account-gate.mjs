/**
 * READ-ONLY account gate for OBJECTIVITY-REFEREE-INTERFACE-DEPENDENCY-GATE-001.
 *
 * FORBIDDEN: create, update, upsert, delete, transaction write, decide API.
 *
 * Usage:
 *   set -a && source .env && set +a
 *   node docs/agent-runs/receipts/OBJECTIVITY-REFEREE-INTERFACE-DEPENDENCY-GATE-001/readonly-account-gate.mjs [--label before|after]
 */
...
async function main() {
  ...
  const out = {
    campaign: "OBJECTIVITY-REFEREE-INTERFACE-DEPENDENCY-GATE-001",
    slice: "OBJECTIVITY-REFEREE-INTERFACE-DEPENDENCY-GATE-001",
