  ...
  it("enforces fanout cap across multiple importExtractedConversations calls (batch-like)", async () => {
    ...
    const referenceRows: Array<{
    ...
    }> = [
      {
        ...
        userId: "user_1",
        type: "constraint",
        statement: "I must finish reading this book and review each chapter for retention",
        status: "candidate",
        confidence: "low",
      ...
      conversations: [
        {
          ...
          messages: [
            { role: "user", content: "I keep skipping chapters, but I also watch videos instead of reading", createdAt: null },
            { role: "user", content: "I keep reading ahead, but I forget to review what I just read", createdAt: null },
            { role: "user", content: "I keep starting new books, but I also abandon the old ones", createdAt: null },
          ],
        },
      ],
      db,
      ...
      conversations: [
        {
          ...
          messages: [
            { role: "user", content: "I keep forgetting to review, but I still move on to the next chapter", createdAt: null },
            { role: "user", content: "I keep watching videos, but I skip the reading and review", createdAt: null },
            { role: "user", content: "I keep putting off review, but I still start the next chapter anyway", createdAt: null },
          ],
        },
      ],
      db,
