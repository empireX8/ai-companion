...
describe("import diagnostics helpers", () => {
  it("round-trips diagnostics through resultErrors metadata", () => {
    ...
    diagnostics.patternRerunDiagnostics = {
      ...
      importedSupportEntriesEvaluatedForEvidenceQuality: 1,
      importedSupportEntriesAcceptedForEvidenceQuality: 1,
      importedSupportEntriesRejectedForEvidenceQuality: 0,
      importedSupportEntriesEvidenceQualityRejectionReasonCounts: {},
      importedSupportEntriesEvidenceQualityRejectedSamples: [],
      supportEntriesSkippedEvidenceQualityGateCount: 0,
