...
} from "../lib/validate-investigation-candidate-review-publish-flow";

async function main(): Promise<void> {
  const parsed = parseValidateInvestigationCandidateReviewPublishCliArgs(process.argv.slice(2));
  if (!parsed.ok) {
